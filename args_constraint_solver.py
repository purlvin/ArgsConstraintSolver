...
def gen_solver_sv(sv, tests, constrains):
    ...
    f.write('    cmd = {"echo ", getenv("ROOT"), "/src/hardware/tb_tensix/tests OUTPUT_DIR=out/ttx/conv_basic", ""," TEST=single-core-conv GENARGS=\'", cmd, "\' compile_test SIM=vcs; ", " cp ", getenv("ROOT"), "/src/hardware/tb_tensix/tests/out/ttx/conv_basic/single-core-conv.ttx core.ttx"};\n')
